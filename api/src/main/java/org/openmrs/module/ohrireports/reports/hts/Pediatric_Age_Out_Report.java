...
@Component
public class Pediatric_Age_Out_Report implements ReportManager {
	...
	public List<Parameter> getParameters() {
		...
		Parameter startDate = new Parameter("startDate", "AgeOut From", Date.class);
		startDate.setRequired(false);
		Parameter startDateGC = new Parameter("startDateGC", " ", Date.class);
		startDateGC.setRequired(false);
		Parameter endDate = new Parameter("endDate", "AgeOut To", Date.class);
